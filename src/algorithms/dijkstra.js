...
function updateUnvisitedNeighbors(node, grid) {
    ...
    for (const neighbor of unvisitedNeighbors) {
        ...
        if (node.distance + additionalDistance < neighbor.distance) {
            neighbor.distance = node.distance + additionalDistance;
...
// Only works when called *after* the algorithm function.
